...
<tbody>
                    <tr>
                      <td class="leftbody" 
                      style="PADDING-RIGHT: 2px; PADDING-LEFT: 2px; PADDING-BOTTOM: 2px; MARGIN: 2px; PADDING-TOP: 2px ">
						...
						?>
						 <li id="level_<?PHP echo $idIndustria; ?>"><a style="PADDING-LEFT: 2px; FONT-SIZE: 12px; MARGIN-LEFT: 2px; width:210px;" 
                          href="buscar.php?im=<?PHP echo $idIndustria; ?>"><?PHP echo $descripcionIndustria; ?></a></li>
						  <?PHP
                   ...
                   <ul>
                      <?PHP
						...
						?>
                            <li><a href="buscar.php?im=<?PHP echo $row_subcat['industria_idindustria']; ?>&amp;ct=<?PHP echo $row_subcat['idcategorias']; ?>" class="submenu"><?PHP echo $row_subcat['descripcionCategoria'];?></a> 
				 <?PHP
						  }
					}				
				?>
...
<div id="tablaOfertas" class="tablaOfertas"></div>
...
<div id="tablaContacto" class="tablaContacto"></div>
...
<div id="btnLogin" class="btnLogin"><a href="registro.php"><img src="img/btnLogin.jpg" width="202" height="49" alt="" border="0"></a></div>
<div class="btnYaEresUsuario style3" id="yaEresUsuario">¿Ya eres usuario?</div>
<div class="btnEntrarCuenta style3" id="btnEntrar"><a  class="estilo2" href="entrar.php">Entrar</a></div>
<div class="style2 rentabilizaEmpresa" id="rentabilizaEmpresa"><strong>Rentabiliza tu Empresa</strong></div>
<?PHP
include("footer.php");
?>
</body>
